	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Update")){	//if we click on register button
			...
			n11=Long.parseLong(t3.getText());
				...
				JOptionPane.showMessageDialog(null,"Enter Integer Contact no");
				t3.setText("0");
			}
			//n11=Integer.parseInt(t4.getText());
			n11=Long.parseLong(t3.getText());
		
			if((t1.getText().trim()).equals("") || pwd1.getPassword().equals("") ||
					(t2.getText().trim()).equals("") || (t3.getText().trim()).equals("") ||
					(t4.getText().trim()).equals("") || pwd2.getPassword().equals("") )
			{
				JOptionPane.showMessageDialog(this, "Field cannot be left empty");
			}
			
			else if(!(pwd3.getPassword().equals(fc.getPwd1()))){
			...
			else if(!(pwd1.getPassword().equals(pwd2.getPassword()))){
			...
			else if((new String(pwd1.getPassword())).length()<8)
			{
				...
				try {
					Connection con=connection.Provider.getConn();
					...
					ps.setString(5,(new String(pwd1.getPassword())));
					...
					fc.setPwd1(new String(pwd1.getPassword()));
